...
motorPWM_left1 = GPIO.PWM(leftPWM1_motor_pin, 50)
motorPWM_left2 = GPIO.PWM(leftPWM2_motor_pin, 50)
motorPWM_right1 = GPIO.PWM(rightPWM1_motor_pin,50)
motorPWM_right2 = GPIO.PWM(rightPWM2_motor_pin,50)
